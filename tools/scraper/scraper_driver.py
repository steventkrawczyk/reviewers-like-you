...
def main():
    ...
    print("Attempting to scrape " + str(total_entries) + " entries overall.")

    while total_entries > 0:
        entries_to_scrape = min(BATCH_SIZE, total_entries)
        print("Attempting to scrape a batch of " + str(entries_to_scrape) + " entries...")
        ...
        print("Scraped " + str(scraped) + " entries!")
