...
//     def _build_average_vector(self, author_vectors: Dict[str, float], dim:
//     int):
//         average_vector = []
...
//     def _build_vector_for_author(self, author: str, movie_indices: Dict[str,
//     int], dim: int):
...
//     def _build_vectors(self, authors: List[str], movie_indices: Dict[str,
//     int], dim: int):
//         author_vectors = dict()
//         for author in authors:
//             author_vector = self._build_vector_for_author(author,
//             movie_indices, dim) author_vectors[author] = author_vector
//         return author_vectors

//     def build_vectors(self, popular_movies: Set[str], authors: List[str]) ->
